                                    ...
                                    <div class="article-list">
                                        ...
                                        <dl class="article-detail">
                                            <c:if test="${article.totop}">
                                                <dt><a href="/articles/${article.id}" target="_blank"><span
                                                        class="text-danger">[置顶]</span>${article.title}</a></dt>
                                            </c:if>
                                            <c:if test="${!article.totop}">
                                                <dt><a href="/articles/${article.id}"
                                                       target="_blank">${article.title}</a></dt>
                                            </c:if>
                                            <dd><i class="glyphicon glyphicon-user"></i><a
                                                    href="/user/${article.user_id}">${article.nickname}</a></dd>
                                        </dl>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button class="btn btn-default" type="submit" style="background-color: #fff"><i
                                            class="fa fa-search" style="color: #34495E"></i></button>
                                </span>
                            </div>
                            <!-- /input-group -->
                        </div>
